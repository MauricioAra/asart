...
import { Collaborator, CollaboratorService } from '../collaborator';
...
export class ProjectDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.collaboratorService.query()
            .subscribe((res: HttpResponse<Collaborator[]>) => { this.collaborators = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackCollaboratorById(index: number, item: Collaborator) {
        return item.id;
    }
}
